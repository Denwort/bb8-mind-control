...
class UDP:
    ...
    @staticmethod
    def send_data(data):
        serialized_data = pickle.dumps(data)  # Serialize the data before sending
        UDP.s.sendto(serialized_data, (UDP.HOST, UDP.PORT))
...
def main():
    ...
    your_app_client_id = 'ZqtpLxw5u9Im10cME5GloUuUagaFNjhpxlrUQCJ0'
    your_app_client_secret = 'W6sksukSkReC7vcEwz4vG5fBpWfr06pEyypueWeEdp8D8DqYEKJ2tnE8KHoRHzMkWzURGRKYXalAMsDlevSBnh1FwcNEYB5yy5cv2KZBsff3gWZ0fjyitzpNC7l6d3Md'

    # Init live advance
    l = LiveAdvance(your_app_client_id, your_app_client_secret)

    trained_profile_name = 'nicolas' # Please set a trained profile name here
